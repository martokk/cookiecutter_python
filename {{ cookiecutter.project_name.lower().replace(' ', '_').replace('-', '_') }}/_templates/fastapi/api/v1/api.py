...
from {{ cookiecutter.project_name.lower().replace(' ', '_').replace('-', '_') }}.api.v1.endpoints import {{ cookiecutter.fastapi_sqlmodel_template_model_name.lower().replace(' ', '_').replace('-', '_') }}
