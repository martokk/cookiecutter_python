...
from {{ cookiecutter.project_name.lower().replace(' ', '_').replace('-', '_') }}.db.crud import {{ cookiecutter.fastapi_sqlmodel_template_model_name.lower().replace(' ', '_').replace('-', '_') }}_crud
