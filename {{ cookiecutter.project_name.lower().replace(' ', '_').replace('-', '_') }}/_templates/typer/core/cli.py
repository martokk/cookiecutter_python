...
from {{ cookiecutter.project_name.lower().replace(' ', '_').replace('-', '_') }}.constants import PACKAGE_DESCRIPTION, PACKAGE_NAME
# from {{ cookiecutter.project_name.lower().replace(' ', '_').replace('-', '_') }}.core.server import start_server
# from {{ cookiecutter.project_name.lower().replace(' ', '_').replace('-', '_') }}.core.app import app
