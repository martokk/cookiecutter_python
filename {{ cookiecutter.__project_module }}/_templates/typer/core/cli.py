...
from {{ cookiecutter.__project_module }} import version
from {{ cookiecutter.__project_module }}.constants import PACKAGE_DESCRIPTION, PACKAGE_NAME
# from {{ cookiecutter.__project_module }}.core.server import start_server
# from {{ cookiecutter.__project_module }}.core.app import app
